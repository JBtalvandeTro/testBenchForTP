...
/* Check if Spi_INIT_PBcfg header file and Spi configuration header file are of the same vendor */
#if (SPI_VENDOR_ID_INIT_PBCFG_H != SPI_VENDOR_ID_CFG)
    #error "Spi_INIT_PBcfg.h and Spi_Cfg.h have different vendor IDs"
#endif
    /* Check if Spi_INIT_PBcfg header file and Spi  configuration header file are of the same Autosar version */
#if ((SPI_AR_RELEASE_MAJOR_VERSION_INIT_PBCFG_H != SPI_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (SPI_AR_RELEASE_MINOR_VERSION_INIT_PBCFG_H != SPI_AR_RELEASE_MINOR_VERSION_CFG) || \
     (SPI_AR_RELEASE_REVISION_VERSION_INIT_PBCFG_H != SPI_AR_RELEASE_REVISION_VERSION_CFG))
#error "AutoSar Version Numbers of Spi_INIT_PBcfg.h and Spi_Cfg.h are different"
#endif
/* Check if Spi_INIT_PBcfg header file and Spi configuration header file are of the same software version */
#if ((SPI_SW_MAJOR_VERSION_INIT_PBCFG_H != SPI_SW_MAJOR_VERSION_CFG) || \
     (SPI_SW_MINOR_VERSION_INIT_PBCFG_H != SPI_SW_MINOR_VERSION_CFG) || \
     (SPI_SW_PATCH_VERSION_INIT_PBCFG_H != SPI_SW_PATCH_VERSION_CFG))
#error "Software Version Numbers of Spi_INIT_PBcfg.h and Spi_Cfg.h are different"
#endif
...
*     for all the driver configurations.
*/
#define SpiConf_SpiJob_Spi_GetLwVoltageMeasures    ((Spi_JobType)0U)
#define SpiConf_SpiJob_Spi_GetHvVoltageMeasures    ((Spi_JobType)1U)
#define SpiConf_SpiJob_Spi_GetHvCurrentMeasures    ((Spi_JobType)2U)
#define SpiConf_SpiJob_Spi_GetHvTemperaturesMeasures    ((Spi_JobType)3U)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiSequence_SpiSequence_GetLowVoltageMeasures    ((Spi_SequenceType)0U)
#define SpiConf_SpiSequence_SpiSequence_GetHvVoltageMeasures    ((Spi_SequenceType)1U)
#define SpiConf_SpiSequence_SpiSequence_GetHvCurrentMeasures    ((Spi_SequenceType)2U)
#define SpiConf_SpiSequence_SpiSequence_GetHvTemperaturesMeasures    ((Spi_SequenceType)3U)
#define SPI_MAX_SEQUENCE 4U
...
*/
#define SPI_LowVoltageMeasurment  ((Spi_ExternalDeviceType)0u)
#define SPI_HighVoltageMeasurment  ((Spi_ExternalDeviceType)1u)
...
*/
#define SPI_TIMEOUT_COUNTER_U32     ((uint32)5000)
