...
#define DMA_IP_CFG_DEVICEREGISTERSV2_AR_RELEASE_MINOR_VERSION        4
#define DMA_IP_CFG_DEVICEREGISTERSV2_AR_RELEASE_REVISION_VERSION     0
#define DMA_IP_CFG_DEVICEREGISTERSV2_SW_MAJOR_VERSION                1
#define DMA_IP_CFG_DEVICEREGISTERSV2_SW_MINOR_VERSION                0
#define DMA_IP_CFG_DEVICEREGISTERSV2_SW_PATCH_VERSION                1
...
/  DMA HWV3 ES MASK                              /
/-----------------------------------------------*/
#define DMA_IP_ES_MASK                      (DMA_ES_DBE_MASK | DMA_ES_SBE_MASK | DMA_ES_SGE_MASK |\
