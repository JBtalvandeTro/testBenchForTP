...
#if (ICU_INIT_PBCFG_VENDOR_ID != ICU_CFG_VENDOR_ID)
    #error "Icu_INIT_PBcfg.h and Icu_Cfg.h have different vendor IDs"
#endif
/* Check if header file and Icu configuration header file are of the same Autosar version */
#if ((ICU_INIT_PBCFG_AR_RELEASE_MAJOR_VERSION != ICU_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (ICU_INIT_PBCFG_AR_RELEASE_MINOR_VERSION != ICU_CFG_AR_RELEASE_MINOR_VERSION) || \
     (ICU_INIT_PBCFG_AR_RELEASE_REVISION_VERSION != ICU_CFG_AR_RELEASE_REVISION_VERSION) \
    )
#error "AutoSar Version Numbers of Icu_INIT_PBcfg.h and Icu_Cfg.h are different"
#endif
/* Check if header file and Icu configuration header file are of the same software version */
#if ((ICU_INIT_PBCFG_SW_MAJOR_VERSION != ICU_CFG_SW_MAJOR_VERSION) || \
     (ICU_INIT_PBCFG_SW_MINOR_VERSION != ICU_CFG_SW_MINOR_VERSION) || \
     (ICU_INIT_PBCFG_SW_PATCH_VERSION != ICU_CFG_SW_PATCH_VERSION) \
    )
#error "Software Version Numbers of Icu_INIT_PBcfg.h and Icu_Cfg.h are different"
#endif
...
#define ICU_MAX_CHANNEL                 ((Icu_ChannelType)6U)
...
#define DSI_CPU1                     (IcuConf_IcuChannel_DSI_CPU1)
#define IcuConf_IcuChannel_DSI_CPU1  ((Icu_ChannelType)0U)
#define DSI_CPU2                     (IcuConf_IcuChannel_DSI_CPU2)
#define IcuConf_IcuChannel_DSI_CPU2  ((Icu_ChannelType)1U)
#define DSI_CPU3                     (IcuConf_IcuChannel_DSI_CPU3)
#define IcuConf_IcuChannel_DSI_CPU3  ((Icu_ChannelType)2U)
#define DSI_CPU4                     (IcuConf_IcuChannel_DSI_CPU4)
#define IcuConf_IcuChannel_DSI_CPU4  ((Icu_ChannelType)3U)
#define DSI_CPU5                     (IcuConf_IcuChannel_DSI_CPU5)
#define IcuConf_IcuChannel_DSI_CPU5  ((Icu_ChannelType)4U)
#define DSI_CPU6                     (IcuConf_IcuChannel_DSI_CPU6)
#define IcuConf_IcuChannel_DSI_CPU6  ((Icu_ChannelType)5U)
/**
