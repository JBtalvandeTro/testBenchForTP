...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if header file and Can_Init_PBcfg.h configuration header file are of the same vendor */
#if (CAN_VENDOR_ID_Init_PBCFG_H != CAN_VENDOR_ID_CFG_H)
#error "Can_Init_PBcfg.h and Can_Cfg.h have different vendor IDs"
#endif
/* Check if header file and Can_Init_PBcfg.h configuration header file are of the same Autosar version */
#if ((CAN_AR_RELEASE_MAJOR_VERSION_Init_PBCFG_H != CAN_AR_RELEASE_MAJOR_VERSION_CFG_H) || \
(CAN_AR_RELEASE_MINOR_VERSION_Init_PBCFG_H != CAN_AR_RELEASE_MINOR_VERSION_CFG_H) || \
(CAN_AR_RELEASE_REVISION_VERSION_Init_PBCFG_H != CAN_AR_RELEASE_REVISION_VERSION_CFG_H) \
    )
#error "AutoSar Version Numbers of Can_Init_PBcfg.h and Can_Cfg.h are different"
#endif
/* Check if header file and Can_Init_PBcfg.h configuration header file are of the same software version */
#if ((CAN_SW_MAJOR_VERSION_Init_PBCFG_H != CAN_SW_MAJOR_VERSION_CFG_H) || \
(CAN_SW_MINOR_VERSION_Init_PBCFG_H != CAN_SW_MINOR_VERSION_CFG_H) || \
(CAN_SW_PATCH_VERSION_Init_PBCFG_H != CAN_SW_PATCH_VERSION_CFG_H) \
    )
#error "Software Version Numbers of Can_Init_PBcfg.h and Can_Cfg.h are different"
#endif
/*==================================================================================================
*                                      DEFINES AND MACROS
==================================================================================================*/
...
*/
#define CAN_MAINFUNCTION_MODE_PERIOD    (0F)
...
*/
#define CAN_HWOBJECT_CONFIG_COUNT    ((Can_HwHandleType)25U)

/**
*   @brief      Symbolic Name generated for Can Controller
*/
#define CanController_Primary    ((uint8)0U)
#define CanController_Maint    ((uint8)2U)
#define CanController_Internal    ((uint8)1U)
/**
*   @brief      Symbolic Name generated for Can HardwareObject
*/
#define Can_Internal_Frame_Rx_CurrentMeasures    ((Can_HwHandleType)0U)
#define Can_Internal_Frame_Rx_PowerMeasures    ((Can_HwHandleType)1U)
#define Can_Internal_Frame_Rx_TempMeasures    ((Can_HwHandleType)2U)
#define Can_Internal_Frame_Rx_VoltageMeasures    ((Can_HwHandleType)3U)
#define Can_Internal_Frame_Rx_RegulationInfos    ((Can_HwHandleType)4U)
#define Can_Internal_Frame_Rx_ControlInfos    ((Can_HwHandleType)5U)
#define Can_Internal_Frame_Rx_Errors    ((Can_HwHandleType)6U)
#define Can_Internal_Frame_Rx_Warnings    ((Can_HwHandleType)7U)
#define Can_Control_Frame_Rx_Cmds    ((Can_HwHandleType)8U)
#define Can_Control_Frame_Rx_ErrorResetReq    ((Can_HwHandleType)9U)
#define Can_Maint_Frame_Rx_EquipmentTestReq    ((Can_HwHandleType)10U)
#define Can_Maint_Frame_Rx_ParamterReq    ((Can_HwHandleType)11U)
#define Can_Internal_Frame_Tx_ErrorResetReq    ((Can_HwHandleType)21U)
#define Can_Internal_Frame_Tx_ControlReq    ((Can_HwHandleType)12U)
#define Can_Internal_Frame_Tx_ModeReq    ((Can_HwHandleType)13U)
#define Can_Control_Frame_Tx_ControlStatus    ((Can_HwHandleType)14U)
#define Can_Control_Frame_Tx_CurrentMeasures    ((Can_HwHandleType)15U)
#define Can_Control_Frame_Tx_ErrorsWarnings    ((Can_HwHandleType)16U)
#define Can_Control_Frame_Tx_PbitResult    ((Can_HwHandleType)17U)
#define Can_Control_Frame_Tx_PowerMeasures    ((Can_HwHandleType)18U)
#define Can_Control_Frame_Tx_TempMeasures    ((Can_HwHandleType)19U)
#define Can_Control_Frame_Tx_VoltageMeasures    ((Can_HwHandleType)20U)
#define Can_Maint_Frame_Tx_EquipmentTest    ((Can_HwHandleType)22U)
#define Can_Maint_Frame_Tx_Paramter    ((Can_HwHandleType)23U)
#define Can_Internal_Frame_Tx_DisableAlarmsRequest    ((Can_HwHandleType)24U)
/**
