...
/* Check if Lpspi_Ip_INIT_PBcfg header file and Spi configuration header file are of the same vendor */
#if (LPSPI_IP_INIT_VENDOR_ID_PBCFG != LPSPI_IP_VENDOR_ID_CFG)
    #error "Lpspi_Ip_INIT_PBcfg.h and Lpspi_Ip_Cfg.h have different vendor IDs"
#endif
    /* Check if Lpspi_Ip_INIT_PBcfg header file and Spi  configuration header file are of the same Autosar version */
#if ((LPSPI_IP_INIT_AR_RELEASE_MAJOR_VERSION_PBCFG != LPSPI_IP_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (LPSPI_IP_INIT_AR_RELEASE_MINOR_VERSION_PBCFG != LPSPI_IP_AR_RELEASE_MINOR_VERSION_CFG) || \
     (LPSPI_IP_INIT_AR_RELEASE_REVISION_VERSION_PBCFG != LPSPI_IP_AR_RELEASE_REVISION_VERSION_CFG))
#error "AutoSar Version Numbers of Lpspi_Ip_INIT_PBcfg.h and Lpspi_Ip_Cfg.h are different"
#endif
/* Check if Lpspi_Ip_INIT_PBcfg header file and Spi configuration header file are of the same software version */
#if ((LPSPI_IP_INIT_SW_MAJOR_VERSION_PBCFG != LPSPI_IP_SW_MAJOR_VERSION_CFG) || \
     (LPSPI_IP_INIT_SW_MINOR_VERSION_PBCFG != LPSPI_IP_SW_MINOR_VERSION_CFG) || \
     (LPSPI_IP_INIT_SW_PATCH_VERSION_PBCFG != LPSPI_IP_SW_PATCH_VERSION_CFG))
#error "Software Version Numbers of Lpspi_Ip_INIT_PBcfg.h and Lpspi_Ip_Cfg.h are different"
#endif
/*==================================================================================================
                                            CONSTANTS
==================================================================================================*/
#define LPSPI_IP_CONFIG_EXT \
    LPSPI_IP_CONFIG_Init_PB \


/** @brief Total number of SpiPhyUnit configured. */
#define LPSPI_IP_NUMBER_OF_INSTANCES  3U
...
*/
#define LPSPI_IP_DMA_USED    (STD_ON)
...
*/
#define LPSPI_IP_HALF_DUPLEX_TIMEOUT_COUNTER     ((uint32)5000U)
/*==================================================================================================
 *                                     DEFINES AND MACROS
==================================================================================================*/
