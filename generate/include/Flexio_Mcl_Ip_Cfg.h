...
==================================================================================================*/
#include "Flexio_Mcl_Ip_Init_PBcfg.h"
...
#define FLEXIO_MCL_IP_CFG_SW_MAJOR_VERSION             1
...
#endif
/* Check if header file and Flexio_Mcl_Ip_Init_PBcfg.h file are of the same vendor */
#if (FLEXIO_MCL_IP_CFG_VENDOR_ID != FLEXIO_MCL_IP_Init_PBCFG_VENDOR_ID)
    #error "Flexio_Mcl_Ip_Cfg.h and Flexio_Mcl_Ip_Init_PBcfg.h have different vendor ids"
#endif

/* Check if header file and Flexio_Mcl_Ip_Init_PBcfg.h file are of the same Autosar version */
#if ((FLEXIO_MCL_IP_CFG_AR_RELEASE_MAJOR_VERSION != FLEXIO_MCL_IP_Init_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (FLEXIO_MCL_IP_CFG_AR_RELEASE_MINOR_VERSION != FLEXIO_MCL_IP_Init_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (FLEXIO_MCL_IP_CFG_AR_RELEASE_REVISION_VERSION != FLEXIO_MCL_IP_Init_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Flexio_Mcl_Ip_Cfg.h and Flexio_Mcl_Ip_Init_PBcfg.h are different"
#endif

/* Check if header file and Flexio_Mcl_Ip_Init_PBcfg.h file are of the same Software version */
#if ((FLEXIO_MCL_IP_CFG_SW_MAJOR_VERSION != FLEXIO_MCL_IP_Init_PBCFG_SW_MAJOR_VERSION) || \
     (FLEXIO_MCL_IP_CFG_SW_MINOR_VERSION != FLEXIO_MCL_IP_Init_PBCFG_SW_MINOR_VERSION) || \
     (FLEXIO_MCL_IP_CFG_SW_PATCH_VERSION != FLEXIO_MCL_IP_Init_PBCFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Flexio_Mcl_Ip_Cfg.h and Flexio_Mcl_Ip_Init_PBcfg.h are different"
#endif
...
/* Logic Channel 1 */
#define MclConf_FlexioMclLogicChannels_FlexioMclLogicChannels_1      ((uint32)CHANNEL_1)
/* Logic Channel 2 */
#define MclConf_FlexioMclLogicChannels_FlexioMclLogicChannels_2      ((uint32)CHANNEL_2)
/* Logic Channel 3 */
#define MclConf_FlexioMclLogicChannels_FlexioMclLogicChannels_3      ((uint32)CHANNEL_3)
