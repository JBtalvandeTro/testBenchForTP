...
#define PWM_CFG_AR_RELEASE_MINOR_VERSION          4
...
/* Check if header file and StandardTypes.h are of the same AUTOSAR version */
        ...
        #error "AUTOSAR version numbers of Pwm_Cfg.h and StandardTypes.h are different."
    #endif
#endif
...
/* Check if header file and PWM configuration header file are of the same vendor */
#if (PWM_CFG_VENDOR_ID != PWM_Init_PB_CFG_VENDOR_ID)
    #error "Pwm_Cfg.h and Pwm_Init_PBcfg.h have different vendor IDs"
#endif
    /* Check if header file and Pwm configuration header file are of the same Autosar version */
#if ((PWM_CFG_AR_RELEASE_MAJOR_VERSION != PWM_Init_PB_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (PWM_CFG_AR_RELEASE_MINOR_VERSION != PWM_Init_PB_CFG_AR_RELEASE_MINOR_VERSION) || \
     (PWM_CFG_AR_RELEASE_REVISION_VERSION != PWM_Init_PB_CFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Pwm_Cfg.h and Pwm_Init_PBcfg.h are different"
#endif
/* Check if header file and Pwm configuration header file are of the same software version */
#if ((PWM_CFG_SW_MAJOR_VERSION != PWM_Init_PB_CFG_SW_MAJOR_VERSION) || \
     (PWM_CFG_SW_MINOR_VERSION != PWM_Init_PB_CFG_SW_MINOR_VERSION) || \
     (PWM_CFG_SW_PATCH_VERSION != PWM_Init_PB_CFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Pwm_Cfg.h and Pwm_Init_PBcfg.h are different"
#endif
...
#define PWM_CONFIG_LOGIC_CHANNELS               (13U)

#define PWM_HW_CHANNEL_NO                       (68U)
...
*
*/
#define MCU_LED1                            ((Pwm_ChannelType)0U)
#define MCU_LED2                            ((Pwm_ChannelType)1U)
#define MCU_LED3                            ((Pwm_ChannelType)2U)
#define MCU_LED4                            ((Pwm_ChannelType)3U)
#define MCU_LED5                            ((Pwm_ChannelType)4U)
#define MCU_LED6                            ((Pwm_ChannelType)5U)
#define DSI_Pbit1                            ((Pwm_ChannelType)6U)
#define DSI_Pbit3                            ((Pwm_ChannelType)7U)
#define DSI_Pbit4                            ((Pwm_ChannelType)8U)
#define DSI_Pbit5                            ((Pwm_ChannelType)9U)
#define DSI_Pbit6                            ((Pwm_ChannelType)10U)
#define CdeS2                            ((Pwm_ChannelType)11U)
#define CdeS3                            ((Pwm_ChannelType)12U)

/**
* @brief        Symbolic name for configured channels - TPS_ECUC_02108 compliant.
*
*/
#define PwmConf_PwmChannelConfigSet_MCU_LED1          ((Pwm_ChannelType)0U)
#define PwmConf_PwmChannelConfigSet_MCU_LED2          ((Pwm_ChannelType)1U)
#define PwmConf_PwmChannelConfigSet_MCU_LED3          ((Pwm_ChannelType)2U)
#define PwmConf_PwmChannelConfigSet_MCU_LED4          ((Pwm_ChannelType)3U)
#define PwmConf_PwmChannelConfigSet_MCU_LED5          ((Pwm_ChannelType)4U)
#define PwmConf_PwmChannelConfigSet_MCU_LED6          ((Pwm_ChannelType)5U)
#define PwmConf_PwmChannelConfigSet_DSI_Pbit1          ((Pwm_ChannelType)6U)
#define PwmConf_PwmChannelConfigSet_DSI_Pbit3          ((Pwm_ChannelType)7U)
#define PwmConf_PwmChannelConfigSet_DSI_Pbit4          ((Pwm_ChannelType)8U)
#define PwmConf_PwmChannelConfigSet_DSI_Pbit5          ((Pwm_ChannelType)9U)
#define PwmConf_PwmChannelConfigSet_DSI_Pbit6          ((Pwm_ChannelType)10U)
#define PwmConf_PwmChannelConfigSet_CdeS2          ((Pwm_ChannelType)11U)
#define PwmConf_PwmChannelConfigSet_CdeS3          ((Pwm_ChannelType)12U)
