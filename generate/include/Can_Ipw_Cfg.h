...
#endif
/* Checks against Can_Ipw_Init_PBcfg.h */
#if (CAN_IPW_CFG_VENDOR_ID != CAN_VENDOR_ID_Init_IPW_PBCFG_H)
    #error "Can_Ipw_Cfg.h and Can_Ipw_Init_PBcfg.h have different vendor ids"
#endif
#if ((CAN_IPW_CFG_AR_RELEASE_MAJOR_VERSION    != CAN_AR_RELEASE_MAJOR_VERSION_Init_IPW_PBCFG_H) || \
     (CAN_IPW_CFG_AR_RELEASE_MINOR_VERSION    != CAN_AR_RELEASE_MINOR_VERSION_Init_IPW_PBCFG_H) || \
     (CAN_IPW_CFG_AR_RELEASE_REVISION_VERSION != CAN_AR_RELEASE_REVISION_VERSION_Init_IPW_PBCFG_H))
    #error "AUTOSAR Version Numbers of Can_Ipw_Cfg.h and Can_Ipw_Init_PBcfg.h are different"
#endif
#if ((CAN_IPW_CFG_SW_MAJOR_VERSION != CAN_SW_MAJOR_VERSION_Init_IPW_PBCFG_H) || \
     (CAN_IPW_CFG_SW_MINOR_VERSION != CAN_SW_MINOR_VERSION_Init_IPW_PBCFG_H) || \
     (CAN_IPW_CFG_SW_PATCH_VERSION != CAN_SW_PATCH_VERSION_Init_IPW_PBCFG_H))
    #error "Software Version Numbers of Can_Ipw_Cfg.h and Can_Ipw_Init_PBcfg.h are different"
#endif
...
#define CAN_FEATURE_HAS_DMA_ENABLE             STD_OFF
#define CAN_FEATURE_HAS_PRETENDED_NETWORKING   STD_OFF 
