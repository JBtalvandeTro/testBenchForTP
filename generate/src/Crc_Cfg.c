...
#define CRC_CFG_AR_RELEASE_MINOR_VERSION_C       4
#define CRC_CFG_AR_RELEASE_REVISION_VERSION_C    0
#define CRC_CFG_SW_MAJOR_VERSION_C               1
#define CRC_CFG_SW_MINOR_VERSION_C               0
#define CRC_CFG_SW_PATCH_VERSION_C               1
...
/* CRC Autosar Channel */
const uint32 Crc_au32Crc8BitSaeJ1850[]     = {CRC_IP_CHANNEL_INVALID_U32};
...
#include "Crc_MemMap.h"
/**
 * @brief  Crc Channels List Of 
 * */
static const uint32 Crc_ChannelsOfPartition[] =
{
    CRC_LOGIC_CHANNEL_0,
    CRC_LOGIC_CHANNEL_1
};
...
{
    /* uint32 ChannelMax    */ 2U,
    /* uint32 * ChannelList */ &Crc_ChannelsOfPartition[0U]
};
