...
#define TRGMUX_IP_Init_PBCFG_AR_RELEASE_MINOR_VERSION_C      4
#define TRGMUX_IP_Init_PBCFG_AR_RELEASE_REVISION_VERSION_C   0
#define TRGMUX_IP_Init_PBCFG_SW_MAJOR_VERSION_C              1
#define TRGMUX_IP_Init_PBCFG_SW_MINOR_VERSION_C              0
#define TRGMUX_IP_Init_PBCFG_SW_PATCH_VERSION_C              1
...
const Trgmux_Ip_LogicTriggerType Trgmux_Ip_LogicTrigger0ConfigPB_INIT =
{
    /* uint8 LogicChannel; */   TRGMUX_LOGIC_GROUP_0_TRIGGER_0,
    /* uint8 Output; */         TRGMUX_IP_OUTPUT_ADC0_ADHWT_TRIG_0,
    /* uint8 Input; */          TRGMUX_IP_INPUT_TRGMUX_IN0,
    /* uint8 HwInstId; */       TRGMUX_IP_HW_INST_0,
    /* boolean Lock; */         (boolean)FALSE,
};

const Trgmux_Ip_LogicTriggerType Trgmux_Ip_LogicTrigger1ConfigPB_INIT =
{
    /* uint8 LogicChannel; */   TRGMUX_LOGIC_GROUP_1_TRIGGER_0,
    /* uint8 Output; */         TRGMUX_IP_OUTPUT_PDB0_TRIGGER_IN0,
    /* uint8 Input; */          TRGMUX_IP_INPUT_LPIT_CH1,
    /* uint8 HwInstId; */       TRGMUX_IP_HW_INST_0,
    /* boolean Lock; */         (boolean)FALSE,
};

/* TRGMUX Initialization Structure */
const Trgmux_Ip_InitType Trgmux_Ip_xTrgmuxInitPB_INIT =
{
    /* Trgmux_Ip_LogicTriggerType * paxLogicTrigger[]; */
    {
		&Trgmux_Ip_LogicTrigger0ConfigPB_INIT,
		&Trgmux_Ip_LogicTrigger1ConfigPB_INIT,
    }
};
