...
static const IntCtrl_Ip_IrqConfigType aIrqConfiguration[] = {
    ...
    {LPSPI0_IRQn, (boolean)TRUE, 0U},
    {LPSPI1_IRQn, (boolean)TRUE, 0U},
    {LPSPI2_IRQn, (boolean)TRUE, 0U},
    {LPI2C1_Master_IRQn, (boolean)FALSE, 0U},
    {LPI2C1_Slave_IRQn, (boolean)FALSE, 0U},
    ...
    {LPIT0_Ch1_IRQn, (boolean)TRUE, 0U},
    {LPIT0_Ch2_IRQn, (boolean)FALSE, 0U},
    {LPIT0_Ch3_IRQn, (boolean)FALSE, 0U},
    {PDB0_IRQn, (boolean)FALSE, 0U},
    {SAI1_TX_SYNC_IRQn, (boolean)FALSE, 0U},
    {SAI1_RX_SYNC_IRQn, (boolean)FALSE, 0U},
    ...
    {PORTD_IRQn, (boolean)TRUE, 0U},
    {PORTE_IRQn, (boolean)TRUE, 0U},
    {SWI_IRQn, (boolean)FALSE, 0U},
    {QSPI_Ored_IRQn, (boolean)FALSE, 0U},
    {PDB1_IRQn, (boolean)FALSE, 0U},
    {FLEXIO_IRQn, (boolean)FALSE, 0U},
    {SAI0_TX_SYNC_IRQn, (boolean)FALSE, 0U},
    {SAI0_RX_SYNC_IRQn, (boolean)FALSE, 0U},
    {ENET_Timer_IRQn, (boolean)FALSE, 0U},
    {ENET_TX_Buffer_IRQn, (boolean)FALSE, 0U},
    {ENET_RX_Buffer_IRQn, (boolean)FALSE, 0U},
    {ENET_PRE_IRQn, (boolean)FALSE, 0U},
    {ENET_STOP_IRQn, (boolean)FALSE, 0U},
    {ENET_WAKE_IRQn, (boolean)FALSE, 0U},
    {CAN0_ORed_IRQn, (boolean)FALSE, 0U},
    {CAN0_Error_IRQn, (boolean)TRUE, 0U},
    ...
    {CAN2_Error_IRQn, (boolean)TRUE, 0U},
    {CAN2_ORed_0_15_MB_IRQn, (boolean)TRUE, 0U},
    {CAN2_ORed_16_31_MB_IRQn, (boolean)TRUE, 0U},
    ...
    {FTM6_Ch0_Ch1_IRQn, (boolean)FALSE, 0U},
    {FTM6_Ch2_Ch3_IRQn, (boolean)FALSE, 0U},
    {FTM6_Ch4_Ch5_IRQn, (boolean)FALSE, 0U},
    {FTM6_Ch6_Ch7_IRQn, (boolean)FALSE, 0U},
    {FTM6_Fault_IRQn, (boolean)FALSE, 0U},
    {FTM6_Ovf_Reload_IRQn, (boolean)FALSE, 0U},
    {FTM7_Ch0_Ch1_IRQn, (boolean)FALSE, 0U},
    {FTM7_Ch2_Ch3_IRQn, (boolean)FALSE, 0U},
    {FTM7_Ch4_Ch5_IRQn, (boolean)FALSE, 0U},
    {FTM7_Ch6_Ch7_IRQn, (boolean)FALSE, 0U},
    {FTM7_Fault_IRQn, (boolean)FALSE, 0U},
    {FTM7_Ovf_Reload_IRQn, (boolean)FALSE, 0U},
};
...
static const IntCtrl_Ip_IrqRouteConfigType aIrqRouteConfig[] = {
    ...
    {LPSPI0_IRQn, 0U, Lpspi_Ip_LPSPI_0_IRQHandler},
    {LPSPI1_IRQn, 0U, Lpspi_Ip_LPSPI_1_IRQHandler},
    {LPSPI2_IRQn, 0U, Lpspi_Ip_LPSPI_2_IRQHandler},
    {LPI2C1_Master_IRQn, 0U, undefined_handler},
    {LPI2C1_Slave_IRQn, 0U, undefined_handler},
    ...
    {LPIT0_Ch0_IRQn, 0U, LPIT_0_CH_0_ISR},
    {LPIT0_Ch1_IRQn, 0U, LPIT_0_CH_1_ISR},
    {LPIT0_Ch2_IRQn, 0U, undefined_handler},
    {LPIT0_Ch3_IRQn, 0U, undefined_handler},
    {PDB0_IRQn, 0U, undefined_handler},
    {SAI1_TX_SYNC_IRQn, 0U, undefined_handler},
    {SAI1_RX_SYNC_IRQn, 0U, undefined_handler},
    ...
    {PORTE_IRQn, 0U, PORT_CI_ICU_IP_E_EXT_IRQ_ISR},
    {SWI_IRQn, 0U, undefined_handler},
    {QSPI_Ored_IRQn, 0U, undefined_handler},
    {PDB1_IRQn, 0U, undefined_handler},
    {FLEXIO_IRQn, 0U, undefined_handler},
    {SAI0_TX_SYNC_IRQn, 0U, undefined_handler},
    {SAI0_RX_SYNC_IRQn, 0U, undefined_handler},
    {ENET_Timer_IRQn, 0U, undefined_handler},
    {ENET_TX_Buffer_IRQn, 0U, undefined_handler},
    {ENET_RX_Buffer_IRQn, 0U, undefined_handler},
    {ENET_PRE_IRQn, 0U, undefined_handler},
    {ENET_STOP_IRQn, 0U, undefined_handler},
    {ENET_WAKE_IRQn, 0U, undefined_handler},
    {CAN0_ORed_IRQn, 0U, undefined_handler},
    {CAN0_Error_IRQn, 0U, CAN0_Error_IRQHandler},
    {CAN0_Wake_Up_IRQn, 0U, undefined_handler},
    {CAN0_ORed_0_15_MB_IRQn, 0U, CAN0_ORED_0_15_MB_IRQHandler},
    {CAN0_ORed_16_31_MB_IRQn, 0U, CAN0_ORED_16_31_MB_IRQHandler},
    {CAN1_ORed_IRQn, 0U, undefined_handler},
    {CAN1_Error_IRQn, 0U, CAN1_Error_IRQHandler},
    {CAN1_ORed_0_15_MB_IRQn, 0U, CAN1_ORED_0_15_MB_IRQHandler},
    {CAN1_ORed_16_31_MB_IRQn, 0U, CAN1_ORED_16_31_MB_IRQHandler},
    ...
    {CAN2_ORed_16_31_MB_IRQn, 0U, CAN2_ORED_16_31_MB_IRQHandler},
    ...
    {FTM4_Ch0_Ch1_IRQn, 0U, undefined_handler},
    {FTM4_Ch2_Ch3_IRQn, 0U, undefined_handler},
    {FTM4_Ch4_Ch5_IRQn, 0U, undefined_handler},
    {FTM4_Ch6_Ch7_IRQn, 0U, undefined_handler},
    {FTM4_Fault_IRQn, 0U, undefined_handler},
    {FTM4_Ovf_Reload_IRQn, 0U, undefined_handler},
    {FTM5_Ch0_Ch1_IRQn, 0U, undefined_handler},
    {FTM5_Ch2_Ch3_IRQn, 0U, undefined_handler},
    {FTM5_Ch4_Ch5_IRQn, 0U, undefined_handler},
    {FTM5_Ch6_Ch7_IRQn, 0U, undefined_handler},
    {FTM5_Fault_IRQn, 0U, undefined_handler},
    {FTM5_Ovf_Reload_IRQn, 0U, undefined_handler},
    {FTM6_Ch0_Ch1_IRQn, 0U, undefined_handler},
    {FTM6_Ch2_Ch3_IRQn, 0U, undefined_handler},
    {FTM6_Ch4_Ch5_IRQn, 0U, undefined_handler},
    {FTM6_Ch6_Ch7_IRQn, 0U, undefined_handler},
    {FTM6_Fault_IRQn, 0U, undefined_handler},
    {FTM6_Ovf_Reload_IRQn, 0U, undefined_handler},
    {FTM7_Ch0_Ch1_IRQn, 0U, undefined_handler},
    {FTM7_Ch2_Ch3_IRQn, 0U, undefined_handler},
    {FTM7_Ch4_Ch5_IRQn, 0U, undefined_handler},
    {FTM7_Ch6_Ch7_IRQn, 0U, undefined_handler},
    {FTM7_Fault_IRQn, 0U, undefined_handler},
    {FTM7_Ovf_Reload_IRQn, 0U, undefined_handler},
};
